...
export const getMovement19Texts = (tonality: string, language: Language): ContainerText[] => {
  ...
  const texts: Record<Language, ContainerText[]> = {
    pt: [
      { redTitle: 'Função 0', grayText: 'Cromático Descendente para o Dominante' },
      { redTitle: 'Função 0', grayText: 'Cromático Descendente para o Dominante' },
      { redTitle: 'Função 0', grayText: 'Cromático Descendente para o Dominante' },
      { redTitle: 'Função 5', grayText: `${chordData.dominantChord} Acorde Dominante` },
      { redTitle: 'Função 0', grayText: `${chordData.passingChord1} Passagem para acorde relativo` },
      { redTitle: 'Função 0', grayText: `${chordData.passingChord2} Passagem para acorde relativo` },
      { redTitle: 'Função 0', grayText: 'Nota de apoio para o acorde relativo' },
      { redTitle: 'Função 1', grayText: `${chordData.relativeChord} Acorde relativo` },
    ],
    en: [
      { redTitle: 'Function 0', grayText: 'Descending Chromatic Chord to the Dominant' },
      { redTitle: 'Function 0', grayText: 'Descending Chromatic Chord to the Dominant' },
      { redTitle: 'Function 0', grayText: 'Descending Chromatic Chord to the Dominant' },
      { redTitle: 'Function 5', grayText: `${chordData.dominantChord} Dominant Chord` },
      { redTitle: 'Function 0', grayText: `${chordData.passingChord1} Passage to Relative Chord` },
      { redTitle: 'Function 0', grayText: `${chordData.passingChord2} Passage to Relative Chord` },
      { redTitle: 'Function 0', grayText: 'Supporting Note for the Relative Chord' },
      { redTitle: 'Function 1', grayText: `${chordData.relativeChord} Relative Chord` },
    ],
    es: [
      { redTitle: 'Función 0', grayText: 'Acorde cromático descendente a la dominante' },
      { redTitle: 'Función 0', grayText: 'Acorde cromático descendente a la dominante' },
      { redTitle: 'Función 0', grayText: 'Acorde cromático descendente a la dominante' },
      { redTitle: 'Función 5', grayText: `${chordData.dominantChord} Acorde de dominante` },
      { redTitle: 'Función 0', grayText: `${chordData.passingChord1} Paso al acorde relativo` },
      { redTitle: 'Función 0', grayText: `${chordData.passingChord2} Paso al acorde relativo` },
      { redTitle: 'Función 0', grayText: 'Nota de apoyo para el acorde relativo' },
