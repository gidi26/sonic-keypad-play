...
const tonalityChords: { [key: number]: { fourth: string; dim: string; main: string } } = {
  1: { fourth: "F", dim: "Gº", main: "C" },      // C
  2: { fourth: "F#", dim: "G#º", main: "C#" },   // C#
  3: { fourth: "G", dim: "Aº", main: "D" },      // D
  4: { fourth: "G#", dim: "A#º", main: "D#" },   // D#
  5: { fourth: "A", dim: "Bº", main: "E" },      // E
  6: { fourth: "A#", dim: "C", main: "F" },      // F
  7: { fourth: "B", dim: "C#", main: "F#" },     // F#
  8: { fourth: "C", dim: "D", main: "G" },       // G
  9: { fourth: "C#", dim: "D#", main: "G#" },    // G#
  10: { fourth: "D", dim: "E", main: "A" },      // A
  11: { fourth: "D#", dim: "F", main: "A#" },    // A#
  12: { fourth: "E", dim: "F#", main: "B" },     // B
};
